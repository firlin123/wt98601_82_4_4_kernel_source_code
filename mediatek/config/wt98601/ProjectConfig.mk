...
CUSTOM_HAL_IMGSENSOR=s5k4h5yx_mipi_raw a5142_mipi_raw ov8858_mipi_raw ov8858gz_mipi_raw nt99252_yuv gc2355_raw 

# = CUSTOM_HAL_MAIN_LENS +CUSTOM_HAL_MAIN_BACKUP_LENS + CUSTOM_HAL_SUB_LENS + CUSTOM_HAL_SUB_BACKUP_LENS
CUSTOM_HAL_LENS=fm50af dw9718af dw9718af_jinkang dummy_lens
...
CUSTOM_HAL_MAIN_IMGSENSOR=s5k4h5yx_mipi_raw a5142_mipi_raw ov8858_mipi_raw ov8858gz_mipi_raw

# lens driver config for main camera
CUSTOM_HAL_MAIN_LENS=fm50af dw9718af dw9718af_jinkang dummy_lens
...
CUSTOM_HAL_SUB_IMGSENSOR=nt99252_yuv gc2355_raw
...
CUSTOM_KERNEL_IMGSENSOR=s5k4h5yx_mipi_raw a5142_mipi_raw ov8858_mipi_raw ov8858gz_mipi_raw nt99252_yuv gc2355_raw
...
CUSTOM_KERNEL_LENS=fm50af dw9718af dw9718af_jinkang dummy_lens
...
CUSTOM_KERNEL_MAIN_IMGSENSOR=s5k4h5yx_mipi_raw a5142_mipi_raw ov8858_mipi_raw ov8858gz_mipi_raw
# lens driver config for main camera
CUSTOM_KERNEL_MAIN_LENS=fm50af dw9718af dw9718af_jinkang dummy_lens
...
CUSTOM_KERNEL_SUB_IMGSENSOR=nt99252_yuv gc2355_raw

# lens driver config for video telephony camera
CUSTOM_KERNEL_SUB_LENS=dummy_lens

# touch driver  need to report correct touch axes
CUSTOM_KERNEL_TOUCHPANEL=GT9XX gsl915
...
CUSTOM_LK_LCM=nt35521_hd720_dsi_vdo hx8394_hd720_dsi_vdo
...
# one load to support different gyroscope sensor
MTK_AUTO_DETECT_GYROSCOPE=yes
...
CUSTOM_MODEM=wingtech82_wet_82kk_hspa_wt_pa_sky77592_band18_std_epskdisable
...
CUSTOM_KERNEL_LCM=nt35521_hd720_dsi_vdo hx8394_hd720_dsi_vdo
...
CUSTOM_UBOOT_LCM=nt35521_hd720_dsi_vdo hx8394_hd720_dsi_vdo
...
MTK_PRODUCT_LOCALES=en_US zh_CN zh_TW uk_UA ru_RU pl_PL cs_CZ tr_TR hu_HU ro_RO bg_BG it_IT es_ES fr_FR pt_PT sl_SI sk_SK lt_LT hr_HR ar_EG iw_IL lv_LV el_GR fa_IR sr_RS hi_IN in_ID th_TH tl_PH vi_VN
...
#CREATE_PROJECT_INFO=20140220235933


MTK_USE_DLINK_MODE=yes



# Wingtech Driver Macro Definition
### use common security key ###
WT_COMMON_SECURITY_KEY = yes

WT_HARDWARE_VERSION = P1
WT_CUSTOMER_NAME = Mika
WT_PRODUCTION_VERSION = Mika_M2_V1.59.18@GSmart

WT_CMCC_VERSION = Mika_M2_V1.59.18@GSmart
WT_CTA_VERSION = Mika_M2_V1.59.18@GSmart

WT_CMCC_SUPPORT = no
MTK_BUILD_VERNO = SW_W98601B4_V024_M10_GIGA_Mika_M2_USR_MP
WT_INNER_VERSION = SW_W98601B4_V024_M10_GIGA_Mika_M2_USR_MP
WT_BUILD_NUMBER = MikaM2V024
WT_PRODUCT_BRAND = GSmart
WT_PRODUCT_NAME = Mika_M2
WT_PRODUCT_DEVICE = Mika_M2

PRODUCT_MANUFACTURER = gigabyte
PRODUCT_MODEL = GSmart Mika M2

WT_LAUNCHER2_ICON_WITH_CUSTOMER_ICON = yes

WT_LAUNCHER_ALLAPPS_WALLPAPER_SUPPORT = yes

WT_LAUNCHER2_ALLAPPS_BACKGROUND_DRAWABLE = yes

FEATURE_FTM_SUB_CAMERA = yes
WT_CUST_MIKA = yes
WT_CUST_MIKA_M2 = yes
WT_ANDROID_MUSIC_SUPPORT = yes
WT_PHONE_NUMBER_MATCH_LENGTH = 8
WT_MIKA_REQ_EAP_SIM_SUPPORT = yes
WT_SUPPORT_FRONT_CAMERA_LOW_FINE_RECORD = yes
MTK_ENGMODE_MAGNETIC_SUPPORT = no
MTK_ENGMODE_GYRO_SUPPORT = no
MTK_ENGMODE_TORCH_SUPPORT = no
# Req_1707 yangqi.wt add for flashlight when new call or mms incoming
WT_FLASHLIGHT_WHEN_INCOMING_CALL_MMS = yes
WT_FOREIGN_LANGUAGE_IP_MENU =yes
WT_BACKLIGHT_DISABLE_WITH_NOLCM = no
