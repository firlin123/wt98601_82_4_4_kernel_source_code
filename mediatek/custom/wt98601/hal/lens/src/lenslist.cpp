...
#endif
#if defined(FM50AF_DALING)
extern PFUNC_GETLENSDEFAULT pFM50AF_daling_getDefaultData;
#endif

#if defined(DW9718AF)
extern PFUNC_GETLENSDEFAULT pDW9718AF_getDefaultData;
#endif
#if defined(DW9718AF_JINKANG)
extern PFUNC_GETLENSDEFAULT pDW9718AF_jinkang_getDefaultData;
#endif
...
#if defined(DW9718AF)
	{OV8858GZ_SENSOR_ID, DW9718AF_LENS_ID, "DW9718AF", pDW9718AF_getDefaultData},
#endif
#if defined(DW9718AF_JINKANG)
	{S5K4H5YX_SENSOR_ID, DW9718AF_JINKANG_LENS_ID, "DW9718AF", pDW9718AF_jinkang_getDefaultData},
#endif
#if defined(FM50AF_DALING)
	{OV5648MIPI_SENSOR_ID, FM50AF_LENS_ID, "FM50AF", pFM50AF_daling_getDefaultData},
#endif
