...
{{
    ...
    ISPCcmPoly22:{
        ...
        28694,    // i4B_STD
        {  // i4P00[9]
            4922000, -2286000, -76000, -882000, 3684000, -242000, -174000, -2816000, 5556000
        },
        {  // i4P10[9]
            1400452, -1509893, 109442, 43841, 125888, -169729, 43217, -390421, 341306
        },
        {  // i4P01[9]
            773166, -713149, -60017, -131721, 86713, 45008, -204767, -1479402, 1680517
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
        ...
        // rHistConfig
        {
            ...
            {86, 100, 128, 148, 170},    // u4HistStretchThres[AE_CCT_STRENGTH_NUM] 
            {18, 20, 26, 30, 34}    // u4BlackLightThres[AE_CCT_STRENGTH_NUM] 
        },
        // rCCTConfig
        {
