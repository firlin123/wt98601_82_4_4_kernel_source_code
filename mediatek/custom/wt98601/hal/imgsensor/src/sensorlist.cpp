...
//----------------------------8m-----------------------
    ...
    RAW_INFO(S5K4H5YX_SENSOR_ID, SENSOR_DRVNAME_S5K4H5YX_MIPI_RAW,NULL), 
#endif
#if defined(OV8858_MIPI_RAW)
    RAW_INFO(OV8858_SENSOR_ID, SENSOR_DRVNAME_OV8858_MIPI_RAW, NULL), 
#endif
#if defined(OV8858GZ_MIPI_RAW)
    RAW_INFO(OV8858GZ_SENSOR_ID, SENSOR_DRVNAME_OV8858GZ_MIPI_RAW, NULL), 
#endif
//----------------------------5m-----------------------
...
//----------------------------2m-----------------------
    ...
    RAW_INFO(GC2355_SENSOR_ID, SENSOR_DRVNAME_GC2355_RAW, NULL), 
#endif
