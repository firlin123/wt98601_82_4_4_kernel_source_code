...
#define NT9252_TEST_PATTERN_CHECKSUM (0x719b1cce)
kal_uint16 NT99252SetTestPatternMode(kal_bool bEnable)
{
	 SENSORDB("[NT99252SetTestPatternMode] Test pattern enable:%d\n", bEnable);
	if(bEnable)    // enable test pattern output 
	{
		...
		NT99252_write_cmos_sensor(0x3200,0x00);
		NT99252_write_cmos_sensor(0x3201,0x02);
		NT99252_write_cmos_sensor(0x303F,0x01);
		NT99252_write_cmos_sensor(0x3012,0x00);
		NT99252_write_cmos_sensor(0x3013,0x00);
		NT99252_write_cmos_sensor(0x301d,0x00);
		NT99252_write_cmos_sensor(0x3291,0x01);
		NT99252_write_cmos_sensor(0x3292,0x00);
		NT99252_write_cmos_sensor(0x3296,0x01);
		NT99252_write_cmos_sensor(0x3297,0x00);
		NT99252_write_cmos_sensor(0x3025,0x02);
	...
	else        //disable test pattern output 
	{
		...
		NT99252_write_cmos_sensor(0x301d,0x01);
		NT99252_write_cmos_sensor(0x3291,0x01);
		NT99252_write_cmos_sensor(0x3292,0x80);
		NT99252_write_cmos_sensor(0x3296,0x01);
		NT99252_write_cmos_sensor(0x3297,0x80);
		NT99252_write_cmos_sensor(0x3025,0x00);
		NT99252_write_cmos_sensor(0x3021,0x06);
		NT99252_write_cmos_sensor(0x3060,0x01);
	}
               return ERROR_NONE;
...
void NT99252_Initial_Setting(void)
{
  ...
  NT99252_write_cmos_sensor(0x3234,0x00);                                         
	...
	#if 1
	NT99252_write_cmos_sensor(0x3302, 0x00);//CC_Matrix_100%_LowContrast
	NT99252_write_cmos_sensor(0x3303, 0x52);
	NT99252_write_cmos_sensor(0x3304, 0x00);
	NT99252_write_cmos_sensor(0x3305, 0x8D);
	NT99252_write_cmos_sensor(0x3306, 0x00);
	NT99252_write_cmos_sensor(0x3307, 0x1F);
	NT99252_write_cmos_sensor(0x3308, 0x07);
	NT99252_write_cmos_sensor(0x3309, 0xCA);
	NT99252_write_cmos_sensor(0x330A, 0x07);
	NT99252_write_cmos_sensor(0x330B, 0x40);
	NT99252_write_cmos_sensor(0x330C, 0x00);
	NT99252_write_cmos_sensor(0x330D, 0xF7);
	NT99252_write_cmos_sensor(0x330E, 0x00);
	NT99252_write_cmos_sensor(0x330F, 0xCD);
	NT99252_write_cmos_sensor(0x3310, 0x07);
	NT99252_write_cmos_sensor(0x3311, 0x3A);
	NT99252_write_cmos_sensor(0x3312, 0x07);
	NT99252_write_cmos_sensor(0x3313, 0xF9);	
	#else
	...
	NT99252_write_cmos_sensor(0x3251, 0x50);//(0x3251,0xe0);//0xcc  //   Weilin 0516                                
	NT99252_write_cmos_sensor(0x3252, 0xA0);//(0x3252,0xA0);//0x48  //Bottom boundary of R / G  Weilin 0516        
	...
	NT99252_write_cmos_sensor(0x3326,0x12); // EEXT Sel                             
	NT99252_write_cmos_sensor(0x3327,0x01);                                         
	...
	NT99252_write_cmos_sensor(0x3331,0x0d); // EMap                                 
	NT99252_write_cmos_sensor(0x3332,0xF0);                                         
	NT99252_write_cmos_sensor(0x3365,0x10);                                         
	NT99252_write_cmos_sensor(0x3366,0x10);                                         
	NT99252_write_cmos_sensor(0x3368,0x28); // Edge Enhance                         
	NT99252_write_cmos_sensor(0x3369,0x24);                                         
	...
	NT99252_write_cmos_sensor(0x337B,0x0F);                                         
	NT99252_write_cmos_sensor(0x337C,0x0F);                                         
	NT99252_write_cmos_sensor(0x3371,0x38); //0x3F // NR_Weight                            
...
{    
  ...
  //[YUYV_1600x1200_10-10fps_60M_2000line]
	...
	NT99252_write_cmos_sensor(0x32B8, 0x3f); 
	NT99252_write_cmos_sensor(0x32B9, 0x31); 
	NT99252_write_cmos_sensor(0x32BC, 0x38); 
	NT99252_write_cmos_sensor(0x32BD, 0x3c); 
	NT99252_write_cmos_sensor(0x32BE, 0x34); 
	...
	NT99252_write_cmos_sensor(0x32C3, 0x02); 
//NT99252_write_cmos_sensor(0x32C4, 0x1C); 
	...
	NT99252_write_cmos_sensor(0x32C8, 0x9c); 
	...
	NT99252_write_cmos_sensor(0x32DB, 0x73);  //AE End
	NT99252_write_cmos_sensor(0x3241, 0x83); 
	NT99252_write_cmos_sensor(0x33A0, 0xB2); 
	NT99252_write_cmos_sensor(0x33A1, 0x54); 
...
//NT99252_write_cmos_sensor(0x302A, 0x00);  //PLL Start
	...
	NT99252_write_cmos_sensor(0x300D, 0xe0); 
...
static void NT99252_video(void)
{
  ...
  //[YUYV_800x600_24.5fps_68M  line2266 for CMCC]
	...
	NT99252_write_cmos_sensor(0x3331,0x0e); 
...
//NT99252_write_cmos_sensor(0x302A, 0x00);  //PLL Start
	...
	NT99252_write_cmos_sensor(0x300A, 0x07); 
	NT99252_write_cmos_sensor(0x300B, 0x83); 
	NT99252_write_cmos_sensor(0x300C, 0x0c); 
	NT99252_write_cmos_sensor(0x300D, 0x30); 
	NT99252_write_cmos_sensor(0x300E, 0x06); 
	NT99252_write_cmos_sensor(0x300F, 0x40); 
	NT99252_write_cmos_sensor(0x3010, 0x04); 
	NT99252_write_cmos_sensor(0x3011, 0xB0);  //Timing End
...
BOOL NT99252_set_param_effect(UINT16 para)
{
   ...
   SENSORDB("[Enter]NT99252 set_param_effect func:para = %d\n",para);
	...
	switch (para)
	{
            ...
            NT99252_write_cmos_sensor(0x32f1,0x05);
            NT99252_write_cmos_sensor(0x32f4,0xC0);  // Weilin 0516
            NT99252_write_cmos_sensor(0x32f5,0x40);  // Weilin 0516
            NT99252_write_cmos_sensor(0x32f8,0x01);
            break;
    ...
    case AE_FLICKER_MODE_60HZ:
        {
			...
			//NT99252_write_cmos_sensor(0x32C6, 0x1C);  
				NT99252_write_cmos_sensor(0x32C7, 0x00);  
				NT99252_write_cmos_sensor(0x32C8, 0x82);  
				NT99252_write_cmos_sensor(0x32C9, 0x78);  
				NT99252_write_cmos_sensor(0x32CA, 0x98);  
				NT99252_write_cmos_sensor(0x32CB, 0x98);  
				NT99252_write_cmos_sensor(0x32CC, 0x98);  
				NT99252_write_cmos_sensor(0x32CD, 0x98);  
				NT99252_write_cmos_sensor(0x32DB, 0x70); 
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    case SENSOR_FEATURE_SET_TEST_PATTERN: //for ata test
		NT99252SetTestPatternMode((BOOL) *pFeatureData16);
	break;
	case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE:
	*pFeatureReturnPara32 = NT9252_TEST_PATTERN_CHECKSUM;
       *pFeatureParaLen=4;
	break;	
    default:
        break;			
