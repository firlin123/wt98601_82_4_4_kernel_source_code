...
static unsigned int g_Cust_Max_Level = 180;   //----------- 100%(255/255)
static unsigned int g_Cust_Min_Level = 26;   // ------------10%£¨26/255£©
static unsigned int lcm_brightness_mapping(unsigned int level)
{
    unsigned int mapped_level;
#ifdef BUILD_LK
    printf("lcm_brightness_mapping OK!\n");
#else
    printk("lcm_brightness_mapping OK!\n");
#endif
	level = ((g_Cust_Max_Level - g_Cust_Min_Level)*level + (255*g_Cust_Min_Level - 30*g_Cust_Max_Level)*4)/(255 - 30);
	mapped_level =(int)level;
...
//	{0xF3,1,{0x01}},
	...
	{0xBC,2,{0x00,0x00}},
	{0xC8,1,{0x80}},
	{0xBD,5,{0x02,0xB0,0x1E,0x1E,0x01}},//00
	{0xC5,2,{0x01,0x07}},
	{0x6F,1,{0x02}},
	{0xB8,1,{0x08}},
	{0xBB,2,{0x55,0x55}},//11
	...
	{0xB0,2,{0x17,0x06}},
	{0xB8,1,{0x08}},
	{0xBD,5,{0x03,0x07,0x00,0x03,0x03}},
	{0xB1,2,{0x17,0x06}},
	{0xB9,2,{0x00,0x07}},
	{0xB2,2,{0x00,0x00}},
	{0xBA,2,{0x00,0x00}},
	...
	{0xD2,5,{0x00,0x05,0x04,0x03,0x10}},
...
params->dsi.vertical_sync_active	=4;//2
	...
	params->dsi.horizontal_backporch	= 50;//80
	params->dsi.horizontal_frontporch	= 50;//86
	params->dsi.horizontal_active_pixel	= FRAME_WIDTH;
	...
	params->dsi.pll_div1=0;		// div1=0,1,2,3;div1_real=1,2,4,4 ----0: 546Mbps  1:273Mbps
	params->dsi.pll_div2=1;		// div2=0,1,2,3;div1_real=1,2,4,4
	params->dsi.fbk_div =20;  //20  // fref=26MHz, fvco=fref*(fbk_div+1)*2/(div1_real*div2_real)
